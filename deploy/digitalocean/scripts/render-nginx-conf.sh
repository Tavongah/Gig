...
export API_DOMAIN ADMIN_DOMAIN APP_DOMAIN
envsubst '${API_DOMAIN} ${ADMIN_DOMAIN} ${APP_DOMAIN}' < "$TEMPLATE" > "$OUTPUT"
echo "Wrote $OUTPUT for API=$API_DOMAIN ADMIN=$ADMIN_DOMAIN APP=$APP_DOMAIN"
